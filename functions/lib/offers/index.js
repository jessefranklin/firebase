...
exports.makeOffer = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    const offer = req.body.offer;
    const post = req.body.post;
    const user = req.body.user;
    const offerProfile = Object.assign({ postId: post.id, applicant: user.id, name: user.name, photoUrl: user.photoUrl, rating: user.rating || 5 }, offer);
    const postOffer = Object.assign({}, offerProfile, { category: post.meta.serviceCategory, title: post.meta.title });
...
exports.approveOffer = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    const offer = req.body.offer;
    ...
    const post = yield admin
        ...
        .once("value");
    const postObj = Object.assign({}, post.val(), { postStatus: "offerApproved", status: "inprogress", approvedOffer: {
...
exports.providerOfferCompleted = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    const offer = req.body.offer;
    const promise1 = admin
        .database()
        .ref(`posts/inprogress/${offer.postId}`)
...
exports.clientOfferCompletedApproval = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    const offer = req.body.offer;
    const promise1 = admin
        .database()
...
exports.closeOffer = functions.database
